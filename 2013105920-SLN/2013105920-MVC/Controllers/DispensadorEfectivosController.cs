...
namespace _2013115366_MVC.Controllers
{
    public class DispensadorEfectivosController : Controller
    {
      //  private CajeroDbContext db = new CajeroDbContext();
        ...
        {
            ViewBag.DispensadorefectivoId = new SelectList(_UnityOfWork.ATM.GetEntity(), "AtmId", "Mensaje");
        ...
        public ActionResult Create([Bind(Include = "DispensadorefectivoId,contador")] DispensadorEfectivo dispensadorEfectivo)
        {
            ...
            ViewBag.DispensadorefectivoId = new SelectList(_UnityOfWork.ATM.GetEntity(), "AtmId", "Mensaje", dispensadorEfectivo.DispensadorefectivoId);
